...
public class CityMap extends JPanel
{
    ...
    // Europe and UK path
    private final static String UK_PATH = "/main/resources/uk.png";
    private final static String EUROPE_PATH = "/main/resources/europe.png";
    ...
    public CityMap(String preset) throws URISyntaxException, IOException
    {
        ...
        BufferedImage rawImage = ImageIO.read(this.getClass().getResource(MAP_PATH));
